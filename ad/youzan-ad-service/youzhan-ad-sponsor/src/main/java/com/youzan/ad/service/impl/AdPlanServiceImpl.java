...
public class AdPlanServiceImpl implements IAdPlanService {
    ...
    @Override
    @Transactional
    public AdPlanResponse creatrPlan(AdPlanRequest planRequest) throws AdException {
        ...
        final AdPlan byUserIdAndPlanName = planRepository.findByUserIdAndPlanName(planRequest.getUserId(), planRequest.getPlanName());
        ...
        //保存
        AdPlan adPlan = planRepository.save(new AdPlan(
    ...
    public AdPlanResponse updatePlan(AdPlanRequest planRequest) throws AdException {
        ...
        if (null!=planRequest.getEndTime()){
            plan.setEndTime(CommonUtils.parseStringDate(
                    planRequest.getEndTime()
            ));
        }

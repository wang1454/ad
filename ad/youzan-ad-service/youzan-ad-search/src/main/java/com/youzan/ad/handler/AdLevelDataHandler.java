...
public class AdLevelDataHandler {
    ...
    public static void handleLevel2(AdPlanTable adPlanTable,
                                    OpType type) {
    ...
    public static void handleLevel2(AdCreativeTbale adCreativeTbale,
                                    OpType type) {
    ...
    public static void handlelevel3(AdUnitTable adUnitTable, OpType type) {
        ...
        if (null == adPlanObject) {
            log.error("the planId is invalid");
            return;
        }
    ...
    public static void handlevel3(AdCreativeUnitTbale adCreativeUnitTbale,
        ...
        if (OpType.UPDATE == type) {
            log.error("No supported updates");
            return;
        }

        DataTable.of(AdUnitIndex.class).get(adCreativeUnitTbale.getUnitId());

        if (null == adCreativeUnitTbale) {
            log.error("No supported updates");
            return;
        }
    ...
    public static void hanfleLevel4(AdUnitDistrictTable adUnitDistrictTable,
                                    OpType type) {
        ...
        if (null == adUnitObject) {
            log.error("the unitid is invalid");
            return;
        }
    ...
    public static void handleLevel4(AdUnitItTable adUnitItTable,
                                    OpType type) {
        if (type == OpType.UPDATE) {
            log.error("No supported updates");
            return;

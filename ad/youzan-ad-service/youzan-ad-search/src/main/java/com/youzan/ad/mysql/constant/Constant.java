...
public class Constant {
    ...
    private static final String DB_NAME="youzan-ad";
    public static class AD_PLAN_TABLE_INFO{
        public static final String TABLE_NAME="ad_plan";
        public static final String COLIMN_ID="id";
        public static final String COLIMN_USER_ID="user_id";
        public static final String COLIMN_PLAN_STATUS="plan_status";
        public static final String COLIMN_START_DATE="start_date";
        public static final String COLIMN_END_DATE="end_date";
    }
    ...
    public static class AD_CREATIVE_TABLE_INFO{
        ...
        public static final String COLUMN_MATERIAL_TYPE="matirial_type";
        public static final String COLUMN_HEIGHT="height";
        public static final String COLUMN_WIDTH="width";
        public static final String COLUMN_AUDIT_STATUS="audit_status";
        public static final String COLUMN_URL="AdUrl";
    }

    public static class AD_UNIT_TABLE_INFO{
        public static final String TABLE_NAME="ad_unit";
        public static final String COLUMN_ID="id";
        public static final String COLUMN_UNTI_STATUS="unit_status";
    ...
    public static class AD_UNIT_IT_TABLE_INFO{
        ...
        public static final String COLUMN_UNIT_ID="unit_id";
        public static final String COLUMN_UNIT_TAG="it_tag";
    }
